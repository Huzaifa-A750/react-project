...
export default function content() {
  return <div className='bg-gradient mb-20'>
    <div className='justify-center grid text-center pt-20 pb-10 shadow-slate-400 shadow-md'>
      <p className='font-[AirBnB-ExtraBold] text-[#3E8180] text-2xl md:text-[42px] font-extrabold leading-9 md:leading-[50px]'>Discover New Construction Homes <br /> Before They Hit The Market</p>
      ...
      <div className='pt-8'>
        <button className=' rounded-md h-[55px] w-[205px] bg-[#E87F3F] text-white font-[AirBnB-Bold]'>Search freshbuilds</button>
      </div>
    </div>
