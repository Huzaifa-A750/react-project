  ...
  return (
    <div className="justify-evenly xl:justify-center lg:flex xl:gap-x-32 py-10 lg:pt-28">
      <div className="lg:justify-start justify-center grid">
        <div className="w-[454px] pt-16 text-center lg:text-start">
          ...
          <div className="pt-10 grid lg:justify-start justify-center">
            <button className="text-base rounded-md h-[55px] w-[205px] hover:border-[#ffdf4e] border-solid border-transparent border-2 bg-[#E87F3F] text-white font-[AirBnB-Medium] hover:tracking-wide hover:drop-shadow-2xl tracking-[0.5px]">
              Search freshbuilds
            </button>
          </div>
        </div>
      ...
      <div className="justify-center flex">
        <div className="w-[329px] h-[466px] justify-center flex">
          <div className="w-[455px] h-[455px] bg-[#5CCAAB] rounded-full absolute"></div>
          <div className="rounded-xl bg-white relative hover:drop-shadow-2xl cursor-pointer hover:border-white border-inherit border-2 border-solid">
            <div className="bg-img h-[249px] w-[329px] rounded-t-md">
